...
<body>
		...
		<div class="hero-text">
			<form action="DenikServlet" method="get">
				...
				<p>Řekni nám o svém výletu na místo, které stojí za to
					...
					kde ti chutnalo ...</p>
				&nbsp; <label><b>AUTOR (toto pole je povinné) </b></label> <input
					type="text" placeholder="Vlož svou přezdívku/jméno"
					name="jmeno_autor" required> &nbsp;
				<p>
					<label><b>NÁZEV(toto pole je povinné)</b></label> <input
	...
	<div class="radio">
		...
		<input type="radio" name="ikona_urceni" value="pes" title="pes">
		<i class="fas fa-dog" title="pes"></i> <br> <br> <input
			type="radio" name="ikona_urceni" value="dite"> <i
			class="fas fa-child" title="dítě"></i><br> <br> <input
			type="radio" name="ikona_urceni" value="invalida"> <i
			class="fab fa-accessible-icon" title="invalida"></i><br>
	...
	<div class="radio2">
		...
		<input type="radio" name="ikona_vylet" value="hrad"><i
			class="fab fa-fort-awesome" title="hrad/zámek"> </i> <br> <br>
		<input type="radio" name="ikona_vylet" value="kostel"><i
			class="fas fa-church" title="kostel"></i><br> <br> <input
			type="radio" name="ikona_vylet" value="rozhledna"> <i
			class="fas fa-chess-rook" title="rozhledna"></i><br> <br> <input
			type="radio" name="ikona_vylet" value="les"> <i
			class="fas fa-tree" title="les"></i><i class="fas fa-tree"
			title="les"></i><br> <br> <input type="radio"
			name="ikona_vylet" value="hory"> <i class="fas fa-mountain"
			title="hory"></i><br> <br> <input type="radio"
			name="ikona_vylet" value="mesto"> <i class="fas fa-city"
			title="mesto"></i><br>

	</div>


	<div class=text-hvezdy>toto hodnocení je povinné</div>
	<fieldset class="rating">
		&nbsp; &nbsp; <input type="radio" id="star5" name="hodnoceni"
			value="5" /><label class="full" for="star5" title="Musíte vidět"></label>
		<br> <br> <input type="radio" id="star4" name="hodnoceni"
			value="4" /><label class="full" for="star4"
			title="Stojí za návštěvu"></label><br> <br> <input
			type="radio" id="star3" name="hodnoceni" value="3" /><label
			class="full" for="star3" title="Dobré"></label><br> <br> <input
			type="radio" id="star2" name="hodnoceni" value="2" /><label
			class="full" for="star2" title="Čekal jsem víc"></label><br> <br>
		<input type="radio" id="star1" name="hodnoceni" value="1" /><label
			class="full" for="star1" title="Nestojí za návštěvu"></label>
	</fieldset>

	<div class="btn-uloz">

		<button type="submit" name="action" value="insert"
			class="filtruj-button">
			Ulož zápis <i ></i>
		</button>
	</div>
	</form>
